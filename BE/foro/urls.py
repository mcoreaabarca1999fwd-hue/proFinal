...
from .views import PublicacionIdCreateView,ComentarioPorPublicacionView
...
urlpatterns = [
    ...
    path('comentarios-publicacion/<int:publicacion_id>/', ComentarioPorPublicacionView.as_view()),
